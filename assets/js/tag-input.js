...
function inputFn() {
    ...
    function TagsInput(element, options) {
        ...
        this.$container = $('<div class="form-control form-control-sm" ></div>');
        this.$input = $(
            '<input [(ngModel)]="control" style="border: none !important;box-shadow: none!important;outline: none!important;background-color: transparent!important;padding: 0 6px!important; margin: 0!important; width: auto!important; max-width: inherit!important; "type="text" placeholder="' + this.placeholderText + '"/>'
    ...
    TagsInput.prototype = {
        ...
        add: function (item, dontPushVal, options) {
            ...
            var $tag = $(
                ...
                '"style="color: white; background-color: #1e81c5ff; border-radius: 5px; ">' +
                htmlEncode(itemText) +
                '<span data-role="remove" class="ps-1 bi bi-x" style="cursor: pointer;"></span></span>'
            );
            $tag.data("item", item);
